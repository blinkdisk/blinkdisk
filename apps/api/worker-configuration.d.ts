/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 95db0a0ca25f55a426d3db8bf053092c)
...
declare namespace Cloudflare {
	interface Env {
		...
		CRON_SECRET: string;
		POSTHOG_LANDING_KEY: string;
		POSTHOG_DESKTOP_KEY: string;
		LOGSNAG_PRIVATE_KEY: string;
		LOGSNAG_PUBLIC_KEY: string;
		JWT_PUBLIC_KEY: string;
		JWT_PRIVATE_KEY: string;
		S3_ENDPOINT: string;
		S3_AMS_ENDPOINT: string;
		S3_LUX_ENDPOINT: string;
		S3_YUL_ENDPOINT: string;
		S3_YVR_ENDPOINT: string;
		S3_REGION: string;
		S3_BUCKET: string;
		S3_KEY_ID: string;
		...
		STORAGE: DurableObjectNamespace /* Storage from cloud */;
		SPACE: DurableObjectNamespace /* Space from cloud */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "API_URL" | "DESKTOP_URL" | "LANDING_URL" | "CLOUD_URL" | "RESEND_API_KEY" | "RESEND_DOMAIN" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "CRON_SECRET" | "POSTHOG_LANDING_KEY" | "POSTHOG_DESKTOP_KEY" | "LOGSNAG_PRIVATE_KEY" | "LOGSNAG_PUBLIC_KEY" | "JWT_PUBLIC_KEY" | "JWT_PRIVATE_KEY" | "S3_ENDPOINT" | "S3_AMS_ENDPOINT" | "S3_LUX_ENDPOINT" | "S3_YUL_ENDPOINT" | "S3_YVR_ENDPOINT" | "S3_REGION" | "S3_BUCKET" | "S3_KEY_ID" | "S3_KEY_SECRET" | "POLAR_ENVIRONMENT" | "POLAR_TOKEN" | "POLAR_WEBHOOK_SECRET">> {}
}
