...
function Folder({ folder }: FolderProps) {
  ...
  return (
    <div
      role="link"
      className="bg-card hover:bg-card-hover ring-ring border-foreground/10 shadow-xs relative flex flex-row items-center justify-between gap-2 rounded-2xl border p-4 outline-none transition-colors focus-visible:ring-2"
    >
      <Link
