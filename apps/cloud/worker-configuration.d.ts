/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 72a0609b366cb2fd8cfffb2ec93f8e07)
// Runtime types generated with workerd@1.20250816.0 2025-08-22 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NODE_ENV: string;
		LOGSNAG_PRIVATE_KEY: string;
		CLOUD_JWT_PUBLIC_KEY: string;
		CLOUD_S3_ENDPOINT: string;
		CLOUD_S3_ENDPOINT_AMS: string;
		CLOUD_S3_ENDPOINT_LUX: string;
		CLOUD_S3_ENDPOINT_YUL: string;
		CLOUD_S3_ENDPOINT_YVR: string;
		CLOUD_S3_REGION: string;
		CLOUD_S3_BUCKET: string;
		CLOUD_S3_KEY_ID: string;
		CLOUD_S3_KEY_SECRET: string;
		EMAIL_DOMAIN: string;
		EMAIL_PROVIDER: string;
		SMTP_URL: string;
		PLUNK_URL: string;
		PLUNK_SECRET_KEY: string;
		SENTRY_CLOUD_DSN: string;
		WRANGLER_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
		VAULT: DurableObjectNamespace<import("./src/index").Vault>;
		SPACE: DurableObjectNamespace<import("./src/index").Space>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "LOGSNAG_PRIVATE_KEY" | "CLOUD_JWT_PUBLIC_KEY" | "CLOUD_S3_ENDPOINT" | "CLOUD_S3_ENDPOINT_AMS" | "CLOUD_S3_ENDPOINT_LUX" | "CLOUD_S3_ENDPOINT_YUL" | "CLOUD_S3_ENDPOINT_YVR" | "CLOUD_S3_REGION" | "CLOUD_S3_BUCKET" | "CLOUD_S3_KEY_ID" | "CLOUD_S3_KEY_SECRET" | "EMAIL_DOMAIN" | "EMAIL_PROVIDER" | "SMTP_URL" | "PLUNK_URL" | "PLUNK_SECRET_KEY" | "SENTRY_CLOUD_DSN" | "WRANGLER_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE">> {}
}
