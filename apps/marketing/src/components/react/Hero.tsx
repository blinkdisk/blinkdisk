      ...
      <div className="flex max-w-[90vw] flex-col items-center text-center md:max-w-[38rem]">
        ...
        <div className="mt-8 flex items-center gap-3 sm:mt-12">
          <a
            ...
            className="animate-fade-in bg-secondary hover:bg-secondary/80 border-border flex size-12 items-center justify-center rounded-md border transition-colors sm:size-14"
          ...
          <a
            href="/download"
            className="animate-fade-in bg-primary text-primary-foreground hover:bg-primary/90 inline-flex h-12 items-center justify-center gap-2 rounded-md px-6 text-sm font-medium transition-colors sm:h-14 sm:px-8 sm:text-base"
