...
Think of compression like vacuum-sealing individual items to remove air and make them smaller. [Deduplication](/glossary/what-is-deduplication-in-backups) is like realizing you have ten identical shirts and only keeping one. Using both together delivers maximum space savings.
...
**[Cloud Backups](/glossary/what-is-cloud-backup)**: When uploading to cloud storage, compression reduces both transfer time and ongoing storage costs. A 200GB backup might take hours to upload uncompressed, but only 45 minutes compressed.
...
**Long-Term Archiving**: Organizations keeping backups for years benefit enormously from compression. The savings compound over time as [retention](/glossary/what-is-retention-in-backups) periods grow.
...
**"[Encrypted](/glossary/what-is-end-to-end-encryption-in-backups) files won't compress"**: While encryption removes patterns that compression exploits, this happens before backup compression runs. Your backup software compresses first, then encrypts, maintaining efficiency.
