...
An [offsite backup](/glossary/what-is-an-offsite-backup) exists in a physically separate location. This could be:

- [Cloud storage](/glossary/what-is-cloud-backup) service
...
| [Ransomware](/glossary/what-is-ransomware)          | Offsite/air-gapped backup survives  |
...
A RAID array protects against drive failure but isn't a true backup. It doesn't protect against ransomware, accidental deletion, or software corruption. You still need separate backup copies. Learn more about [local backups](/glossary/what-is-a-local-backup).
...
| --------- | --------------------------- | --------------------------- |
| **+1**    | One offline/air-gapped copy | Survives [ransomware](/glossary/what-is-ransomware) attacks |
...
| [Encryption](/glossary/what-is-end-to-end-encryption-in-backups)            | Protect data during transfer and storage        |
...
Modern ransomware can encrypt or delete cloud backups. Immutable storage prevents modification or deletion for a specified period, ensuring you always have a clean restore point. This is essential for effective [disaster recovery](/glossary/what-is-disaster-recovery).
