...
export const Route = createFileRoute("/(legal)/privacy")({
  ...
  head: head({
    ...
    description: "The privacy policy for BlinkDisk.",
  }),
});
...
*   **Application** refers to BlinkDisk Desktop, the software program provided by the Company.
    
*   **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Paul Köck, Wolf-Huber-Straße 31.
...
*   **Website** refers to BlinkDisk, accessible from [https://blinkdisk.com](https://blinkdisk.com)
...
*   By email: paul@blinkdisk.com`}</Legal>
  );
}
